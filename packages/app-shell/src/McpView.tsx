      ...
      <div className="mcpView__scroll">
        <section className="mcpCard">
          ...
          <ul className="mcpList">
            <li>
              Works with your local project paths (npm, Composer, Swift, CocoaPods, Flutter, Go,
              Rust, Ruby, Gradle…)
            </li>
        ...
        <section className="mcpCard mcpCard--actions">
          <button
            ...
            onClick={() => void onOpenUrl("https://github.com/mehdiraized/npmax")}
          >
          ...
          <button
            ...
            className="btn btn--ghost"
            onClick={() =>
              void onOpenUrl("https://modelcontextprotocol.io/docs/getting-started/intro")
            }
          >
            What is MCP?
          </button>
